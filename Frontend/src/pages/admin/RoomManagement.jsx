            ...
            <div className="max-w-7xl mx-auto p-8">
                <div className="mb-8">
                    <div className="flex justify-between items-center">
                        ...
                        >
                            <button className="cursor-pointer flex items-center gap-2 bg-blue-600 text-white px-3 py-2.5 rounded-lg hover:bg-sky-700 transition-all duration-200 shadow-sm hover:shadow-md font-medium">
                                <PlusSquare size={22} />
                                Room
                            </button>
                        </AddRoomDialog>
                                                ...
                                                <td className="px-6 py-4 whitespace-nowrap">
                                                    <div className="flex items-center gap-3">
                                                        <button
                                                            ...
                                                            className="cursor-pointer p-2 text-green-600 hover:text-gray-900 hover:bg-gray-100 rounded-lg transition-all duration-200"
                                                            title="Edit room"
                                                        >
                                                            <EditIcon size={22} />
                                                        </button>
                                                        ...
                                                        >
                                                            <button className="cursor-pointer p-2 text-gray-600 hover:text-red-600 hover:bg-red-50 rounded-lg transition-all duration-200">
                                                                <FiTrash2 size={18} />
                                                            </button>
                                                        </DeleteConfirmDialog>
                                                    </div>
