...
function Signup() {
  ...
  return <Form route="app/user/register" method="signup" />
    ...
    //         <input type="text" name="username" value={formData.username} onChange={handleChange} placeholder="Username" className="font-semibold outline py-1 px-3 rounded" />
    //       </div>

    //       <div className="flex flex-col gap-y-2">
    //         <label className="font-bold">Email</label>
    //         <input type="email" name="email" value={formData.email} onChange={handleChange} placeholder="Email" className="font-semibold outline py-1 px-3 rounded"/>
    //       </div>

    //       <div className="flex flex-col gap-y-2">
    //         <label className="font-bold">Password</label>
    //         <input type="password" name="password" value={formData.password} onChange={handleChange} placeholder="Password" className="font-semibold outline py-1 px-3 rounded"/>
    //       </div>

    //       <div className="flex flex-col gap-y-2">
    //         <label className="font-bold">Confirm Password</label>
    //         <input type="password" name="confirmPassword" value={formData.confirmPassword} onChange={handleChange} placeholder="Confirm Password" className="font-semibold outline py-1 px-3 rounded"/>
    //       </div>
