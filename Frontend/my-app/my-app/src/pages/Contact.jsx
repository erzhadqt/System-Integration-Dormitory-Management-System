...
const Contact = () => {
  return (
    <div className="h-screen bg-cover bg-center relative" style={{ backgroundImage: "url('/bg-picture1.jpg')" }}>
        ...
        <div className="z-20 flex flex items-center justify-center h-full px-6 text-center text-2xl font-bold">
            <FaFacebook size={40} className="text-blue-600 hover:text-blue-800 cursor-pointer m-5" />GenTech
            <FaEnvelope  size={40} className="text-red-500 hover:text-red-700 cursor-pointer m-5" />gentech123@gmail.com
